      ...
      <div class="container align-self-center">
        <div class="row">
          <div class="col-md-12 capa">
            ...
            <a href="" class="btn btn-lg btn-custom btn-roxo">Aporveite o Spotify Free</a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <h3>Músicas</h3>
            <p>O Spotify tem milhões de músicas. Escute seus sons favoritos, descubra novas músicas e teúna seus favoritos em um só lugar.</p>

            <h3>Playlists</h3>
            <p>No Spotify você encontra uma playlist para cada momento. Todas feitas por fanáticos e especialistas da música.</p>

            <h3>Novos lançamentos</h3>
            <p>Escute os novos lançamentos de singles e álguns da semana e veja o que est´a bombvando no Top 50.</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <h3>Navegar</h3>
            <p>Veja os novos lançamentos, o que está bombando nas paradas eas melhores plaulists para o seu momento.</p>
